                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.blogs')}}"> المدونة </a>
                                ...
                                <li class="breadcrumb-item active"> تعديل  المدونة - {{$blog->name }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل المدونة</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$blog->name}}" id="name"
                                                                class="form-control"
                                                                placeholder="الاسم"
                                                                name="name">
                                                            @error("name")
